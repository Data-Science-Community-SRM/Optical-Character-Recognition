...
from structured_images_1 import structured
from Text_Detection_and_Recognition import outputfunc
## Sidebar
...
def how_to_run():
    ...
    st.write("""
             ...
             #### The image and this file should be in the same folder.
             """)
             
    st.text("\n")
    
    st.write("""
             ### For uploading Untructured images (Any real life image):
                 Click on "Upload Unstructured "
    ...
    st.write("""
             ### For uploading Structured images (PDFs, Screenshots, Page of a Book):
                 Click on "Upload Structured"
...
def upload_image():
       ...
       ##Upload from desktop
        ...
        img = st.file_uploader("Upload Unstructured", type=["jpeg", "png", "jpg"], accept_multiple_files=False)
        if img is not None:
